...
export function Error404() {
  return (
    <>
      ...
      {/* Title */}
      <h1 className="mb-4 text-white text-5xl bg-gradient-to-r from-emerald-200 via-emerald-400 to-emerald-200 bg-clip-text text-transparent">
        Bài Hát Không Tìm Thấy
      </h1>

      {/* Description */}
      <p className="mb-8 text-emerald-100/60 max-w-md mx-auto text-lg">
        Có vẻ như bài hát bạn đang tìm kiếm không tồn tại hoặc đã bị gỡ khỏi
        playlist. Hãy thử tìm kiếm lại hoặc quay về trang chủ.
      </p>
